...
FIGURES = [
    ...
    ("Fig5_clinical_robustness",
     ...
     "best zero-shot foil Chronos-Bolt) share fixed colours across panels. (a) Early-warning lead time "
     "--- share of hypotension events flagged $\\geq$2 and $\\geq$5 min ahead; the trained baselines "
     "flag marginally more events early, consistent with their longer-horizon edge. (b) "
     "Severity-stratified detection: a 2$\\times$2 of AUROC vs horizon, one panel per hypotension "
     "threshold/duration (MAP$<$65, $<$55, $<$50, and $<$65 sustained $\\geq$5 min), the four models "
     "overlaid. (c) Subgroup robustness: per-subgroup hypotension AUROC at 5 min --- TiRex-2 (point + "
     "case-clustered 95\\% CI) with TFT, PatchTST and Chronos-Bolt overlaid; TiRex-2 stays close to its "
     "overall value across every subgroup. (d) Operating characteristics at specificity $\\geq$0.90: a "
     "2$\\times$2, one panel per metric (sensitivity, PPV, NPV, F1), the four models overlaid across "
     "horizons. Trained baselines are all-cases 5-fold out-of-fold; TiRex-2 and Chronos-Bolt are "
     "zero-shot."),
    ("Fig6_transfer",
